...
void main() {
  group('Grupo de teste do TextFormField PWD', () {
    testWidgets('Renderizar corretmente o CustomTextField', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Exibe corretamente quando fornecido', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('Verificar se obscureText oculta o texto do campo', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('Verificar se o suffixIcon mostra a imagem corretamente', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
      ...
      expect(
        ...
        findsOneWidget,
        reason: 'Deve apresentar o icone Icons.visibility_off_outlined',
      );
    ...
    testWidgets('Verificar se controller está sendo preenchida', (
      WidgetTester tester,
    ) async {
      ...
      await tester.pump();
      expect(controller.text, "Senha do Usuário");
    });
  });
}
