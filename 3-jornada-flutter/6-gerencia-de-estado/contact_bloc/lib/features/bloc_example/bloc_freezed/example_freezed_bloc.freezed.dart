...
abstract class $ExampleFreezedEventCopyWith<$Res> {
  factory $ExampleFreezedEventCopyWith(
    ExampleFreezedEvent value,
    $Res Function(ExampleFreezedEvent) then,
...
class __$$ExampleFreezedEventFindNamesImplCopyWithImpl<$Res>
    extends
        _$ExampleFreezedEventCopyWithImpl<
          $Res,
...
class _$ExampleFreezedEventRemoveNameImpl
  ...
  const _$ExampleFreezedEventRemoveNameImpl({required this.name});
...
abstract class _ExampleFreezedEventRemoveName implements ExampleFreezedEvent {
  const factory _ExampleFreezedEventRemoveName({required final String name}) =
      _$ExampleFreezedEventRemoveNameImpl;
...
abstract class $ExampleFreezedStateCopyWith<$Res> {
  factory $ExampleFreezedStateCopyWith(
    ExampleFreezedState value,
    $Res Function(ExampleFreezedState) then,
...
class __$$ExampleFreezedStateInitialImplCopyWithImpl<$Res>
    extends
        _$ExampleFreezedStateCopyWithImpl<
          $Res,
...
class _$ExampleFreezedStateInitialImpl implements _ExampleFreezedStateInitial {
  const _$ExampleFreezedStateInitialImpl();
...
abstract class _ExampleFreezedStateInitial implements ExampleFreezedState {
  const factory _ExampleFreezedStateInitial() =
      _$ExampleFreezedStateInitialImpl;
}
...
class _$ExampleFreezedStateLoadingImpl implements _ExampleFreezedStateLoading {
  const _$ExampleFreezedStateLoadingImpl();
...
abstract class _ExampleFreezedStateLoading implements ExampleFreezedState {
  const factory _ExampleFreezedStateLoading() =
      _$ExampleFreezedStateLoadingImpl;
}
...
class __$$ExampleFreezedStateBannerImplCopyWithImpl<$Res>
    extends
        _$ExampleFreezedStateCopyWithImpl<$Res, _$ExampleFreezedStateBannerImpl>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? names = null, Object? message = null}) {
    return _then(
...
class _$ExampleFreezedStateBannerImpl implements _ExampleFreezedStateBanner {
  const _$ExampleFreezedStateBannerImpl({
...
abstract class _ExampleFreezedStateBanner implements ExampleFreezedState {
  const factory _ExampleFreezedStateBanner({
    required final List<String> names,
...
class __$$ExampleFreezedStateDataImplCopyWithImpl<$Res>
    extends
        _$ExampleFreezedStateCopyWithImpl<$Res, _$ExampleFreezedStateDataImpl>
...
class _$ExampleFreezedStateDataImpl implements _ExampleFreezedStateData {
  const _$ExampleFreezedStateDataImpl({required final List<String> names})
    : _names = names;
